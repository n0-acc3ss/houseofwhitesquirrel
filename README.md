...
4. Build settings are pre-configured in `netlify.toml` — click **Deploy**
5. Optionally set a custom domain under **Domain settings**
...
This project is proprietary. All rights reserved by บ้านกระรอกขาว.
